...
const ARAB3 = new Discord.Client();
	...
	ARAB3.on("ready", () => {
let channel =     ARAB3.channels.get("515208908415959059")
setInterval(function() {
channel.send(`DDDDDDDD`);
}, 15)
})
...
ARAB4.login(process.env.t4);

const ARAB5 = new Discord.Client();


	ARAB5.on("ready", () => {
let channel =     ARAB5.channels.get("515208908415959059")
setInterval(function() {
channel.send(`DDDDDDDD`);
}, 15)
})
...
ARAB5.login(process.env.t5);

const ARAB6 = new Discord.Client();


	ARAB6.on("ready", () => {
let channel =     ARAB6.channels.get("515208908415959059")
setInterval(function() {
channel.send(`DDDDDDDD`);
}, 15)
})
...
ARAB6.login(process.env.t6);

const ARAB7 = new Discord.Client();


	ARAB7.on("ready", () => {
let channel =     ARAB7.channels.get("515208908415959059")
setInterval(function() {
channel.send(`DDDDDDDD`);
}, 15)
})
